...
struct AABB
{
    ...
    // Attention attention! This is_empty() method is completely inverted to a normal is_empty() method
    // Please remove it in the following commit. we replaced it with is_valid() below.
	bool is_empty() const
	{
		for (int i = 0; i < 3; ++i)
		{
